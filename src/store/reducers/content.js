...
const reducer = ( state = initialState, action ) => {
    switch ( action.type ) {
        case actionTypes.LANGUAGE_CHANGED: return onChangeLanguageActionReceived(state, action);
        case actionTypes.LANGUAGE_CHANGED_SHOW_HIDE_SPINNER: return onShowHideSpinnerByAction(state, action);
        default:
            return state;
    }
};
